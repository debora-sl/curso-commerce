...
export const schema = yup
  .object({
    ...
    email: yup.string().required('O email é obrigatório.').email('O email deve ser válido, por favor verificar.'),
    mobile: yup
    .string()
    .required('O celular é obrigatório.')
    .transform((value) => value.replace(/[^\d]/g, ''))
    .test('validateMobile', 'O celular preenchido inválido.', (value) => isValidPhone(value)),
  })
  .required()
